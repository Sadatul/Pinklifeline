    ...
    return (
        <div className="flex flex-col w-full gap-7 p-7 relative break-normal">
            ...
            {editable ? (
                        ...
                        <div className="flex flex-col flex-1 gap-3">
                            ...
                            <div className="flex flex-row gap-7">
                                <div className="text-md font-semibold flex gap-2 items-center" >
                                    <span className="w-32">Last Period Date:</span>
                                    <Popover>
                            ...
                            <div className="flex flex-row items-center">
                                <div className="text-md font-semibold flex flex-row gap-2 items-center">
                                    <span className="w-32">Menstrual Cycle:</span>
                            ...
                            <div className="flex flex-col justify-start w-full items-start  gap-5">
                                <div className="flex flex-col">
                                    <div className="text-md font-semibold flex items-center gap-2" >
                                        <span className="w-32">Diagnose Date:</span>
                                        <Popover>
                                            <PopoverTrigger asChild>
                                                <Button
                                                    variant={"outline"}
                        ...
                        <div className="flex flex-col w-7/12 gap-3">
                            ...
                            <div className="w-full">
                                <div className="flex flex-col justify-between w-full  gap-3">
                                    ...
                                    {cancerHistory === "Y" &&
                                        <div className={cn("flex items-center w-full justify-between gap-2")}>
                                            <div className="flex items-center gap-5">
                                                <div className="text-md font-semibold gap-2 flex">
                                                    <span className="w-40">
                                                        Cancer Relatives
                                                    </span>
                                                    <input className="border border-blue-500 rounded-md px-2 w-64" id="cancerRelatives" />
                                                </div>
                                                <Button
                                                    onClick={() => {
                ...
                <>
                    <div className="flex flex-row w-full bg-gray-100 p-4 rounded-md flex-wrap">
                        <div className="flex flex-col flex-1 gap-3">
                            <div className="text-md font-semibold">
                        ...
                        <Separator orientation="vertical" className="-translate-x-10 w-[1.5px] bg-gray-400" />
                        <div className="flex flex-col flex-1 gap-3">
                            {isPatient &&
                                <div className=" flex flex-col">
                                    <div className="text-md font-semibold text-gray-800 flex items-center gap-2">
                                        ...
                                        <span>: {userData.cancerStage?.replace("_", " ")}</span>
                                    </div>
                                </div>
                            }
                            <div className="w-full">
                                    ...
                                    {userData?.cancerHistory === "Y" &&
                                        <div className="flex items-center">
                                            <div className="text-md font-semibold text-gray-800 flex items-center gap-2">
                                                ...
                                                <span>: {userData?.cancerRelatives?.join(", ")}</span>
                                            </div>
                                        </div>
                                    }
                                </div>
                            ...
                            <div className="w-full ">
                                <div className="flex items-center justify-between w-full">
                                    <div className="text-md font-semibold text-gray-800 flex items-center gap-2">
                                        ...
                                        <span>: {userData?.medications?.map((medication) => `${medication.name}:: ${medication.doseDescription}`).join(", ")}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
