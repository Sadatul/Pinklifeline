...
ALTER TABLE forum_answers
    ADD CONSTRAINT FK_FORUM_ANSWERS_ON_FORUM_QUESTION FOREIGN KEY (forum_question_id) REFERENCES forum_questions (id);

ALTER TABLE forum_answers
    ADD CONSTRAINT FK_FORUM_ANSWERS_ON_PARENT_ANSWER FOREIGN KEY (parent_answer) REFERENCES forum_answers (id);

ALTER TABLE forum_answers
    ADD CONSTRAINT FK_FORUM_ANSWERS_ON_USER FOREIGN KEY (user_id) REFERENCES users (id);

ALTER TABLE forum_answer_votes
    ADD CONSTRAINT FK_FORUM_ANSWER_VOTES_ON_FORUM_ANSWER FOREIGN KEY (forum_answer_id) REFERENCES forum_answers (id);
...
ALTER TABLE forum_question_votes
    ADD CONSTRAINT FK_FORUM_QUESTION_VOTES_ON_FORUM_QUESTION FOREIGN KEY (forum_question_id) REFERENCES forum_questions (id);
